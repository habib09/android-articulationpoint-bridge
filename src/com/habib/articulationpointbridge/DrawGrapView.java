...
public class DrawGrapView extends SurfaceView implements Callback {
	...
	private int left = 240, top = 20, right = 760, bottom = 100; //rectangle parameter
	...
	private void constructGrap() {
		...
		DrawGrap.edgeU = edgeU;
		DrawGrap.edgeV = edgeV;
		DrawGrap.vertexPoint = vertexPoint;
		mainActivity.dfs(grap.size());
	}
	...
	private void draw(){
		...
		canvas.drawText("ArticulationPoint&Bridge", left, 70, textpaint);
